...
<head>
  ...
  <title>Nexus - SaaS Landing Page Template</title>
  ...
  <section class="home-section" id="home">
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <!--begin col-md-8-->
        <div class="col-md-8 mx-auto text-center padding-top-40">

          <h1>The Wold's Most Advanced CRM Tool</h1>

          <p>Nexus is designed with your customers in mind, so you can track and analyze all your data at any time in
            one central location. Get started today!</p>
        ...
        <div class="col-md-6">
          ...
          <div class="main-services">
            ...
            <div class="main-services-text">
              ...
              <p>Curabitur quam etsum lacus netsum nulat etis vitae etsum nisle varius netsum edinusedit nisle ipsum
                nisle antes metrix netsum.</p>
        ...
        <div class="col-md-6">
          ...
          <div class="main-services">
            ...
            <div class="main-services-text">
              ...
              <p>Curabitur quam etsum lacus netsum nulat iaculis ets vitae etsum nisle varius netsum edsimuned nisle.
              </p>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-6 padding-top-10 padding-left-20">
          ...
          <p>Work is completely different today. Teams are more agile, more collaborative and drive innovation faster
            than ever — and the most successful companies have a digital workplace to match.</p>

          <p>Nexus is designed with your customers in mind, so you can track and analyze all your data in one central
            location.</p>
        ...
        <div class="col-md-6 responsive-top-margins wow slideInRight" data-wow-delay="0.25s"
          ...
          <div class="video-popup-wrapper">
            ...
            <div class="popup-gallery">
              ...
              <img src="http://placehold.it/765x515" class="width-100 video-popup-image" alt="pic">
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <div class="col-md-12 text-center padding-bottom-40">
          ...
          <h2 class="section-title white-text">How To Use Nexus</h2>
                  ...
                  <div class="col-md-4 col-sm-4 col-xs-6">
                    <figure class="gallery-item">
                      ...
                      <div class="popup-gallery popup-gallery-rounded portfolio-pic">
                        <a class="popup2" href="http://placehold.it/770x480">
                          <img src="http://placehold.it/770x480" class="width-100" alt="pic">
      ...
      <div class="row">
          ...
          <div class="accordion" id="accordionFAQ">
            ...
            <div class="card">
              ...
              <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionFAQ">
                <div class="card-body">
                  Nemo enim ipsam voluptatem quia voluptas sit aspernatur netsum loris fugit, sed quia magni dolores eos
                  qui ratione sequi nesciunt, neque et quis autem velis reprehenderit ets quis velit.
                </div>
              </div>
        ...
        <div class="col-md-6 responsive-top-margins">
          ...
          <div class="chat-box">
            ...
            <p>We hope our answers to some of your frequently asked questions help, but if you have any further queries,
              please don't hesitate to get in touch today.</p>
        ...
        <div class="col-md-4">
          ...
          <div class="price-box">
            ...
            <ul class="pricing-list">
              ...
              <li class="price-text white-text"><i class="fas fa-check blue"></i><strong>All Standard Features</strong>
              </li>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-12 text-center padding-top-10 padding-bottom-20">
          ...
          <h3 class="section-title white-text">Fun Facts About Nexus</h3>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-12 text-center">
          ...
          <h2 class="section-title">The Team Behind Nexus</h2>
        ...
        <div class="col-sm-12 col-md-4">
          ...
          <div class="team-item">
            ...
            <img src="http://placehold.it/380x380" class="team-img" alt="pic">
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-6 responsive-bottom-margins wow slideInLeft" data-wow-delay="0.25s"
          ...
          <img src="http://placehold.it/800x600" class="width-100 box-shadow" alt="pic">
        ...
        <div class="col-md-6 padding-top-20">
          ...
          <div class="features-second">
            ...
            <p>With Nexus getting your team on board is as simple as sending an email.</p>
          ...
          <div class="features-second">
            ...
            <p>Analyze customers by region, discounts and more and put a plan in place to improve subscriber retention.
            </p>
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          ...
          <div class="feature-box wow fadeIn" data-wow-delay="0.25s"
            ...
            <p>Utise wisi enim minim veniam, quis et stationes ullamcorper suscipit ets lobotis nisle consequat nihis
              etim.</p>
        ...
        <div class="col-md-4">
          ...
          <div class="blog-item">
            ...
            <div class="blog-item-inner">
              ...
              <p>Quis autem velis ets reprehender net etid quiste voluptate velite esse quam nihis etsa sedit netsid
                varias.</p>
    ...
    <div class="container-fluid px-0">
      ...
      <div class="row no-gutters mx-0">
        ...
        <div class="col-md-4 footer-grey-box text-center">
          ...
          <a href="#" class="footer-links">Meet The Team Behind Nexus</a>
      ...
      <div class="row">
        ...
        <div class="col-md-12 footer-bottom text-center">
          ...
          <p>Copyright © 2019 <strong>Nexus</strong>. Designed by <a
              href="https://themeforest.net/user/epic-themes/portfolio?ref=Epic-Themes" target="_blank">Epic-Themes</a>
          </p>
